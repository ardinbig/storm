...
A Flutter App for fuel station management.
...
_\*Storm works on iOS, Android, Web, and Windows._
...
```arb
{
    ...
    "appTitle": "Storm",
    "@appTitle": {
        "description": "Text shown in the AppBar of the Storm Application."
    },
    "hello": "Hello",
    "@hello": {
...
```arb
{
    ...
    "appTitle": "Storm",
    "@appTitle": {
        "description": "Texte affiché dans la barre d'application de Storm."
    },
    "hello": "Bonjour",
    "@hello": {
        "description": "Salutation Bonjour."
    }
}
```
